...
QString Theme::styleSheet() const
{
  if (mDark) {
    return
      ...
      "}"
      "DiffView InfoWidget QLabel {"
      "  color: palette(bright-text)"
      "}"
      "DiffView ImageWidget {"
      "  border-top: 1px solid palette(mid)"
      "}"
      "DiffView ImageWidget QLabel {"
      "  color: palette(bright-text)"
      "}"
      "DiffView ResolutionWidget {"
      "  border-top: 1px solid palette(mid)"
      "}"
      "DiffView ResolutionWidget QLabel {"
      "  color: palette(bright-text)"
      "}"
      "DiffView HunkWidget {"
      "  border-top: 1px solid palette(mid)"
      ...
      "ResolutionWidget QToolButton:pressed,"
